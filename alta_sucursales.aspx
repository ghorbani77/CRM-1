<%@ Page Language="C#" AutoEventWireup="true" CodeFile="codigo/alta_sucursales.aspx.cs" Inherits="alta_sucursales" %>
...
<head id="Head1" runat="server">
    <title>Alta de sucursales - Inklaser</title>
...
<body bgcolor="#0080c0">
    ...
    <span class="titulo left">Alta de sucursales</span>
        </div>
    ...
    <div class="large-12 columns">
        ...
        <ul class="">
           <li><p><asp:Label ID="nombre" runat="server">Cliente</asp:Label></p>
            <asp:DropDownList ID="lista_nombres" runat="server" CssClass="lista" 
                    AutoPostBack="True" Enabled="True" 
                    onselectedindexchanged="lista_nombres_SelectedIndexChanged"></asp:DropDownList></li>

            <li><p><asp:Label ID="comercial" runat="server">Comercial</asp:Label></p><asp:TextBox ID="caja_comercial" runat="server" CssClass="caja_mediana" Style="text-transform: uppercase" MaxLength="200" Enabled="False"></asp:TextBox></li>
            
            <li class="li-inline"><p><asp:Label ID="tipo" runat="server" >Tipo de cliente</asp:Label></p><asp:DropDownList ID="tipo_cliente" runat="server" CssClass="lista micha" Enabled="False">
          ...
          <asp:ListItem>Mayoreo</asp:ListItem>
            ...
            <li><p><asp:Label ID="rfc" runat="server">RFC</asp:Label></p><asp:TextBox ID="caja_rfc" runat="server" CssClass="caja_chica micha" Style="text-transform: uppercase" MaxLength="30" Enabled="False"></asp:TextBox></li>
        ...
        <div class="large-6 columns"> 
           ...
           <div class="large-12 titulo-circulo">
        <i class="fa fa-bank prod"></i>
            <span>Datos de la nueva sucursal</span></div>
    ...
    <ul class="inline-list">
        ...
        <li><p><asp:Label ID="sucursal" runat="server">Sucursal</asp:Label></p><asp:TextBox ID="caja_sucursal" runat="server" CssClass="caja_mediana micha" Style="text-transform: uppercase" MaxLength="200"></asp:TextBox></li>
    ...
    <ul>
        ...
        <li><p><asp:Label ID="codigo_postal" runat="server">Codigo postal</asp:Label></p>
            ...
            AutoPostBack="True" Enabled="True" 
                onselectedindexchanged="caja_codigo_postal_SelectedIndexChanged"></asp:DropDownList></li>
    ...
    <ul>
        <li><p><asp:Label ID="referencia_ubicacion" runat="server">Referencia de ubicacion</asp:Label></p><asp:TextBox ID="caja_referencia" runat="server" CssClass="caja_larga" Enabled="True" Style="text-transform: uppercase"></asp:TextBox></li>
    
        <li><p><asp:Label ID="telefono" runat="server">Telefono</asp:Label></p><asp:TextBox ID="caja_telefono" runat="server" CssClass="caja_chica" MaxLength="30" Style="text-transform: uppercase"></asp:TextBox></li>
        ...
        <li><p><asp:Label ID="correo" runat="server">Correo</asp:Label></p><asp:TextBox ID="caja_correo" runat="server" CssClass="caja_mediana" MaxLength="200" Style="text-transform: uppercase"></asp:TextBox></li>
    </ul>
