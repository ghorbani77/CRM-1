<%@ Page Language="C#" AutoEventWireup="true" CodeFile="codigo/imprimir_pic_ticket.aspx.cs" Inherits="imprimir_pic_ticket" %>
...
<body>
    ...
    <ul class="vertical">
     <li><asp:Label ID="caja_pedido" runat="server" CssClass="caja_sucursal"></asp:Label></li>
    ...
    <asp:GridView ID="tabla_productos" runat="server" CssClass="tabla" DataSource='<%# datos_productos_pedido() %>'  
