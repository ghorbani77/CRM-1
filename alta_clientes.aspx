<%@ Page Language="C#" AutoEventWireup="true" CodeFile="codigo/alta_clientes.aspx.cs" Inherits="alta_clientes" %>
    ...
    (function () {
        ...
        setInterval(function () {
            if (!mouse && !keyboard) {
                ...
                mouse = false;
                keyboard = false;
                if (document.getElementById('caja_contador'))
                {
...
<body bgcolor="#0080c0">
    ...
    <ContentTemplate>
     ...
     <div class="large-12 header-cotizaciones header-alta header-prom">
        <div class="controles">
            <span class="titulo left">Alta de clientes</span>
        </div>
    ...
    <ul class="">
            <li><p><asp:Label ID="nombre" runat="server">Nombre (Excluir Acentos)</asp:Label></p><asp:TextBox ID="caja_nombre" onpaste="return false" runat="server" CssClass="caja_mediana" Style="text-transform: uppercase" MaxLength="200"></asp:TextBox></li>
            
            <li><p><asp:Label ID="comercial" runat="server">Nombre Comercial (Excluir Acentos)</asp:Label></p><asp:TextBox ID="caja_comercial" onpaste="return false" runat="server" CssClass="caja_mediana" Style="text-transform: uppercase" MaxLength="200"></asp:TextBox></li>
            ...
            <li><p><asp:Label ID="Label1" runat="server">Público en general(sin RFC) </asp:Label><asp:CheckBox ID="rfc_null" runat="server" CssClass="caja_mini micha" ></asp:CheckBox></p></li>
      </ul>

    <ul class="inline-list">
    
        
        <li><p><asp:Label ID="zona_mensajeria" runat="server">Zona de mensajeria</asp:Label></p><asp:DropDownList ID="lista_zonas" runat="server" CssClass="lista micha">
          ...
          <asp:ListItem>Oeste</asp:ListItem>
            ...
            <ul>
        <li><p><asp:Label ID="calle" runat="server">Calle (Excluir Acentos)</asp:Label></p><asp:TextBox ID="caja_calle" runat="server" CssClass="caja_mediana" Style="text-transform: uppercase" MaxLength="400"></asp:TextBox></li>
        
        </ul>
            
            <ul class="inline-list">
                
                <li><p><asp:Label ID="numero_exterior" runat="server" CssClass="texto">Numero exterior</asp:Label></p><asp:TextBox ID="caja_numero_exterior" runat="server" CssClass="caja_mini micha" MaxLength="6"></asp:TextBox></li>
        
                <li><p>Numero interior</p><asp:TextBox ID="caja_numero_interior" runat="server" CssClass="caja_super_mini micha" MaxLength="6" Style="text-transform: uppercase"></asp:TextBox></li>
    ...
    <ul>
        ...
        <li><p><asp:Label ID="pais" runat="server">Pais</asp:Label></p>
            <asp:DropDownList ID="lista_paises" runat="server" CssClass="lista" 
          ...
          <li>  <p><asp:Label ID="estado" runat="server">Estado</asp:Label></p>
              <asp:DropDownList ID="lista_estados" runat="server" CssClass="lista" 
                  ...
                  onselectedindexchanged="lista_estados_SelectedIndexChanged">
          </asp:DropDownList></li>
        ...
        <li><p><asp:Label ID="codigo_postal" runat="server">Codigo postal</asp:Label></p>
            <asp:DropDownList 
            ID="caja_codigo_postal" runat="server" CssClass="caja_mini" 
            onselectedindexchanged="caja_codigo_postal_SelectedIndexChanged" 
            AutoPostBack="True" Enabled="False"></asp:DropDownList></li>
    
        <li>   <p> 
            <asp:Label ID="colonia" runat="server">Colonia</asp:Label></p>
            <asp:DropDownList ID="lista_colonias" runat="server" CssClass="lista" 
                AutoPostBack="True" Enabled="False" 
                onselectedindexchanged="lista_colonias_SelectedIndexChanged">
          </asp:DropDownList>
    </li>
    </ul>
    ...
    <ul>
        <li><p><asp:Label ID="referencia_ubicacion" runat="server">Referencia de ubicacion (Excluir Acentos)</asp:Label></p><asp:TextBox ID="caja_referencia" runat="server" CssClass="caja_larga" MaxLength="2000"></asp:TextBox></li>
    ...
    <asp:LinkButton ID="boton_guardar" runat="server" 
                ToolTip="Guardar registro del nuevo cliente" style="text-decoration:none" 
                CssClass="boton_guardar button small success" onclick="boton_guardar_Click" 
                OnClientClick="desactivar_boton();" Visible="False">Guardar</asp:LinkButton>
