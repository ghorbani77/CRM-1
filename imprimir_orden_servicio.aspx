<%@ Page Language="C#" AutoEventWireup="true" CodeFile="codigo/imprimir_orden_servicio.aspx.cs" Inherits="imprimir_orden_servicio" %>
...
<script type="text/javascript" language="javascript">
    ...
    function cerrar() {
        document.location.href = "orden_servicio.aspx";
    }
...
<body>
    ...
    <asp:TextBox ID="aclaracion_3" runat="server" CssClass="caja_sucursal" 
             BorderStyle="None" Height="50px" Width="700px" TextMode="MultiLine" 
